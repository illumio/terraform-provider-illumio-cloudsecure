...
type OrganizationPolicy_Scopes struct {
	state         protoimpl.MessageState             `protogen:"open.v1"`
	Scope         []*OrganizationPolicy_Scopes_Scope `protobuf:"bytes,1,rep,name=scope,proto3" json:"scope,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OrganizationPolicy_Scopes) Reset() {
	*x = OrganizationPolicy_Scopes{}
	mi := &file_illumio_cloud_config_v1_config_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OrganizationPolicy_Scopes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrganizationPolicy_Scopes) ProtoMessage() {}

func (x *OrganizationPolicy_Scopes) ProtoReflect() protoreflect.Message {
	mi := &file_illumio_cloud_config_v1_config_proto_msgTypes[91]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrganizationPolicy_Scopes.ProtoReflect.Descriptor instead.
func (*OrganizationPolicy_Scopes) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_config_v1_config_proto_rawDescGZIP(), []int{91}
}

func (x *OrganizationPolicy_Scopes) GetScope() []*OrganizationPolicy_Scopes_Scope {
	if x != nil {
		return x.Scope
	}
	return nil
...
type CreateOrganizationPolicyRequest struct {
	...
	Name          string                       `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`
	Scopes        []*OrganizationPolicy_Scopes `protobuf:"bytes,6,rep,name=scopes,proto3" json:"scopes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateOrganizationPolicyRequest) GetScopes() []*OrganizationPolicy_Scopes {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *CreateOrganizationPolicyResponse) GetScopes() []*OrganizationPolicy_Scopes {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *ReadOrganizationPolicyResponse) GetScopes() []*OrganizationPolicy_Scopes {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *UpdateOrganizationPolicyRequest) GetScopes() []*OrganizationPolicy_Scopes {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *UpdateOrganizationPolicyResponse) GetScopes() []*OrganizationPolicy_Scopes {
	if x != nil {
		return x.Scopes
	}
	return nil
...
func (x *OrganizationPolicy_Scopes_Scope) Reset() {
	*x = OrganizationPolicy_Scopes_Scope{}
	mi := &file_illumio_cloud_config_v1_config_proto_msgTypes[117]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OrganizationPolicy_Scopes_Scope) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrganizationPolicy_Scopes_Scope) ProtoMessage() {}

func (x *OrganizationPolicy_Scopes_Scope) ProtoReflect() protoreflect.Message {
	mi := &file_illumio_cloud_config_v1_config_proto_msgTypes[117]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrganizationPolicy_Scopes_Scope.ProtoReflect.Descriptor instead.
func (*OrganizationPolicy_Scopes_Scope) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_config_v1_config_proto_rawDescGZIP(), []int{91, 0}
}

func (x *OrganizationPolicy_Scopes_Scope) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *OrganizationPolicy_Scopes_Scope) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
const file_illumio_cloud_config_v1_config_proto_rawDesc = "" +
	...
	"\x19OrganizationPolicy_Scopes\x12N\n" +
	"\x05scope\x18\x01 \x03(\v28.illumio.cloud.config.v1.OrganizationPolicy_Scopes.ScopeR\x05scope\x1a1\n" +
	"\x05Scope\x12\x14\n" +
	...
	"\x06scopes\x18\x06 \x03(\v22.illumio.cloud.config.v1.OrganizationPolicy_ScopesR\x06scopesB\x0e\n" +
	...
	"\x04name\x18\x04 \x01(\tR\x04name\x12J\n" +
	"\x06scopes\x18\x06 \x03(\v22.illumio.cloud.config.v1.OrganizationPolicy_ScopesR\x06scopesB\x0e\n" +
	"\f_description\"\x9f\x02\n" +
	"\x1fUpdateOrganizationPolicyRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12%\n" +
	"\vdescription\x18\x02 \x01(\tH\x00R\vdescription\x88\x01\x01\x12\x18\n" +
	"\aenabled\x18\x03 \x01(\bR\aenabled\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12J\n" +
	"\x06scopes\x18\x06 \x03(\v22.illumio.cloud.config.v1.OrganizationPolicy_ScopesR\x06scopes\x12;\n" +
	"\vupdate_mask\x18\x05 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMaskB\x0e\n" +
	"\f_description\"\xe3\x01\n" +
	...
	"\x10DeleteDeployment\x120.illumio.cloud.config.v1.DeleteDeploymentRequest\x1a\x16.google.protobuf.Empty\x12k\n" +
...
var file_illumio_cloud_config_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 118)
var file_illumio_cloud_config_v1_config_proto_goTypes = []any{
	...
	(*CreateK8SClusterRequest)(nil),                      // 77: illumio.cloud.config.v1.CreateK8SClusterRequest
	(*CreateK8SClusterResponse)(nil),                     // 78: illumio.cloud.config.v1.CreateK8SClusterResponse
	(*ReadK8SClusterRequest)(nil),                        // 79: illumio.cloud.config.v1.ReadK8SClusterRequest
	(*ReadK8SClusterResponse)(nil),                       // 80: illumio.cloud.config.v1.ReadK8SClusterResponse
	(*UpdateK8SClusterRequest)(nil),                      // 81: illumio.cloud.config.v1.UpdateK8SClusterRequest
	(*UpdateK8SClusterResponse)(nil),                     // 82: illumio.cloud.config.v1.UpdateK8SClusterResponse
	(*DeleteK8SClusterRequest)(nil),                      // 83: illumio.cloud.config.v1.DeleteK8SClusterRequest
	(*CreateK8SClusterOnboardingCredentialRequest)(nil),  // 84: illumio.cloud.config.v1.CreateK8SClusterOnboardingCredentialRequest
	(*CreateK8SClusterOnboardingCredentialResponse)(nil), // 85: illumio.cloud.config.v1.CreateK8SClusterOnboardingCredentialResponse
	(*ReadK8SClusterOnboardingCredentialRequest)(nil),    // 86: illumio.cloud.config.v1.ReadK8SClusterOnboardingCredentialRequest
	(*ReadK8SClusterOnboardingCredentialResponse)(nil),   // 87: illumio.cloud.config.v1.ReadK8SClusterOnboardingCredentialResponse
	...
	(*OrganizationPolicy_Scopes)(nil),                    // 91: illumio.cloud.config.v1.OrganizationPolicy_Scopes
	(*CreateOrganizationPolicyRequest)(nil),              // 92: illumio.cloud.config.v1.CreateOrganizationPolicyRequest
	(*CreateOrganizationPolicyResponse)(nil),             // 93: illumio.cloud.config.v1.CreateOrganizationPolicyResponse
	(*ReadOrganizationPolicyRequest)(nil),                // 94: illumio.cloud.config.v1.ReadOrganizationPolicyRequest
	(*ReadOrganizationPolicyResponse)(nil),               // 95: illumio.cloud.config.v1.ReadOrganizationPolicyResponse
	(*UpdateOrganizationPolicyRequest)(nil),              // 96: illumio.cloud.config.v1.UpdateOrganizationPolicyRequest
	(*UpdateOrganizationPolicyResponse)(nil),             // 97: illumio.cloud.config.v1.UpdateOrganizationPolicyResponse
	(*DeleteOrganizationPolicyRequest)(nil),              // 98: illumio.cloud.config.v1.DeleteOrganizationPolicyRequest
	(*OrganizationPolicyRule_FromLabels)(nil),            // 99: illumio.cloud.config.v1.OrganizationPolicyRule_FromLabels
	(*OrganizationPolicyRule_ToLabels)(nil),              // 100: illumio.cloud.config.v1.OrganizationPolicyRule_ToLabels
	(*OrganizationPolicyRule_ToPortRanges)(nil),          // 101: illumio.cloud.config.v1.OrganizationPolicyRule_ToPortRanges
	(*CreateOrganizationPolicyRuleRequest)(nil),          // 102: illumio.cloud.config.v1.CreateOrganizationPolicyRuleRequest
	(*CreateOrganizationPolicyRuleResponse)(nil),         // 103: illumio.cloud.config.v1.CreateOrganizationPolicyRuleResponse
	(*ReadOrganizationPolicyRuleRequest)(nil),            // 104: illumio.cloud.config.v1.ReadOrganizationPolicyRuleRequest
	(*ReadOrganizationPolicyRuleResponse)(nil),           // 105: illumio.cloud.config.v1.ReadOrganizationPolicyRuleResponse
	(*UpdateOrganizationPolicyRuleRequest)(nil),          // 106: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleRequest
	(*UpdateOrganizationPolicyRuleResponse)(nil),         // 107: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleResponse
	(*DeleteOrganizationPolicyRuleRequest)(nil),          // 108: illumio.cloud.config.v1.DeleteOrganizationPolicyRuleRequest
	(*TagToLabel_Icon)(nil),                              // 109: illumio.cloud.config.v1.TagToLabel_Icon
	(*CreateTagToLabelRequest)(nil),                      // 110: illumio.cloud.config.v1.CreateTagToLabelRequest
	(*CreateTagToLabelResponse)(nil),                     // 111: illumio.cloud.config.v1.CreateTagToLabelResponse
	(*ReadTagToLabelRequest)(nil),                        // 112: illumio.cloud.config.v1.ReadTagToLabelRequest
	(*ReadTagToLabelResponse)(nil),                       // 113: illumio.cloud.config.v1.ReadTagToLabelResponse
	(*UpdateTagToLabelRequest)(nil),                      // 114: illumio.cloud.config.v1.UpdateTagToLabelRequest
	(*UpdateTagToLabelResponse)(nil),                     // 115: illumio.cloud.config.v1.UpdateTagToLabelResponse
	(*DeleteTagToLabelRequest)(nil),                      // 116: illumio.cloud.config.v1.DeleteTagToLabelRequest
	(*OrganizationPolicy_Scopes_Scope)(nil),              // 117: illumio.cloud.config.v1.OrganizationPolicy_Scopes.Scope
...
var file_illumio_cloud_config_v1_config_proto_depIdxs = []int32{
	118, // 0: illumio.cloud.config.v1.UpdateApplicationRequest.update_mask:type_name -> google.protobuf.FieldMask
	118, // 1: illumio.cloud.config.v1.UpdateApplicationAwsResourcesRequest.update_mask:type_name -> google.protobuf.FieldMask
	118, // 2: illumio.cloud.config.v1.UpdateApplicationAzureResourcesRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	118, // 15: illumio.cloud.config.v1.UpdateApplicationPolicyRuleRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	118, // 19: illumio.cloud.config.v1.UpdateAwsAccountRequest.update_mask:type_name -> google.protobuf.FieldMask
	118, // 20: illumio.cloud.config.v1.UpdateAwsFlowLogsS3BucketRequest.update_mask:type_name -> google.protobuf.FieldMask
	118, // 21: illumio.cloud.config.v1.UpdateAzureFlowLogsStorageAccountRequest.update_mask:type_name -> google.protobuf.FieldMask
	118, // 22: illumio.cloud.config.v1.UpdateAzureSubscriptionRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	118, // 31: illumio.cloud.config.v1.UpdateDeploymentRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	118, // 42: illumio.cloud.config.v1.UpdateIpListRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	118, // 45: illumio.cloud.config.v1.UpdateK8SClusterRequest.update_mask:type_name -> google.protobuf.FieldMask
	118, // 46: illumio.cloud.config.v1.UpdateK8SClusterOnboardingCredentialRequest.update_mask:type_name -> google.protobuf.FieldMask
	117, // 47: illumio.cloud.config.v1.OrganizationPolicy_Scopes.scope:type_name -> illumio.cloud.config.v1.OrganizationPolicy_Scopes.Scope
	91,  // 48: illumio.cloud.config.v1.CreateOrganizationPolicyRequest.scopes:type_name -> illumio.cloud.config.v1.OrganizationPolicy_Scopes
	91,  // 49: illumio.cloud.config.v1.CreateOrganizationPolicyResponse.scopes:type_name -> illumio.cloud.config.v1.OrganizationPolicy_Scopes
	91,  // 50: illumio.cloud.config.v1.ReadOrganizationPolicyResponse.scopes:type_name -> illumio.cloud.config.v1.OrganizationPolicy_Scopes
	91,  // 51: illumio.cloud.config.v1.UpdateOrganizationPolicyRequest.scopes:type_name -> illumio.cloud.config.v1.OrganizationPolicy_Scopes
	118, // 52: illumio.cloud.config.v1.UpdateOrganizationPolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	91,  // 53: illumio.cloud.config.v1.UpdateOrganizationPolicyResponse.scopes:type_name -> illumio.cloud.config.v1.OrganizationPolicy_Scopes
	99,  // 54: illumio.cloud.config.v1.CreateOrganizationPolicyRuleRequest.from_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_FromLabels
	100, // 55: illumio.cloud.config.v1.CreateOrganizationPolicyRuleRequest.to_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToLabels
	101, // 56: illumio.cloud.config.v1.CreateOrganizationPolicyRuleRequest.to_port_ranges:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToPortRanges
	99,  // 57: illumio.cloud.config.v1.CreateOrganizationPolicyRuleResponse.from_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_FromLabels
	100, // 58: illumio.cloud.config.v1.CreateOrganizationPolicyRuleResponse.to_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToLabels
	101, // 59: illumio.cloud.config.v1.CreateOrganizationPolicyRuleResponse.to_port_ranges:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToPortRanges
	99,  // 60: illumio.cloud.config.v1.ReadOrganizationPolicyRuleResponse.from_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_FromLabels
	100, // 61: illumio.cloud.config.v1.ReadOrganizationPolicyRuleResponse.to_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToLabels
	101, // 62: illumio.cloud.config.v1.ReadOrganizationPolicyRuleResponse.to_port_ranges:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToPortRanges
	99,  // 63: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleRequest.from_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_FromLabels
	100, // 64: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleRequest.to_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToLabels
	101, // 65: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleRequest.to_port_ranges:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToPortRanges
	118, // 66: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleRequest.update_mask:type_name -> google.protobuf.FieldMask
	99,  // 67: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleResponse.from_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_FromLabels
	100, // 68: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleResponse.to_labels:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToLabels
	101, // 69: illumio.cloud.config.v1.UpdateOrganizationPolicyRuleResponse.to_port_ranges:type_name -> illumio.cloud.config.v1.OrganizationPolicyRule_ToPortRanges
	109, // 70: illumio.cloud.config.v1.CreateTagToLabelRequest.icon:type_name -> illumio.cloud.config.v1.TagToLabel_Icon
	109, // 71: illumio.cloud.config.v1.CreateTagToLabelResponse.icon:type_name -> illumio.cloud.config.v1.TagToLabel_Icon
	109, // 72: illumio.cloud.config.v1.ReadTagToLabelResponse.icon:type_name -> illumio.cloud.config.v1.TagToLabel_Icon
	109, // 73: illumio.cloud.config.v1.UpdateTagToLabelRequest.icon:type_name -> illumio.cloud.config.v1.TagToLabel_Icon
	118, // 74: illumio.cloud.config.v1.UpdateTagToLabelRequest.update_mask:type_name -> google.protobuf.FieldMask
	109, // 75: illumio.cloud.config.v1.UpdateTagToLabelResponse.icon:type_name -> illumio.cloud.config.v1.TagToLabel_Icon
	0,   // 76: illumio.cloud.config.v1.ConfigService.CreateApplication:input_type -> illumio.cloud.config.v1.CreateApplicationRequest
	2,   // 77: illumio.cloud.config.v1.ConfigService.ReadApplication:input_type -> illumio.cloud.config.v1.ReadApplicationRequest
	4,   // 78: illumio.cloud.config.v1.ConfigService.UpdateApplication:input_type -> illumio.cloud.config.v1.UpdateApplicationRequest
	6,   // 79: illumio.cloud.config.v1.ConfigService.DeleteApplication:input_type -> illumio.cloud.config.v1.DeleteApplicationRequest
	7,   // 80: illumio.cloud.config.v1.ConfigService.CreateApplicationAwsResources:input_type -> illumio.cloud.config.v1.CreateApplicationAwsResourcesRequest
	9,   // 81: illumio.cloud.config.v1.ConfigService.ReadApplicationAwsResources:input_type -> illumio.cloud.config.v1.ReadApplicationAwsResourcesRequest
	11,  // 82: illumio.cloud.config.v1.ConfigService.UpdateApplicationAwsResources:input_type -> illumio.cloud.config.v1.UpdateApplicationAwsResourcesRequest
	13,  // 83: illumio.cloud.config.v1.ConfigService.DeleteApplicationAwsResources:input_type -> illumio.cloud.config.v1.DeleteApplicationAwsResourcesRequest
	14,  // 84: illumio.cloud.config.v1.ConfigService.CreateApplicationAzureResources:input_type -> illumio.cloud.config.v1.CreateApplicationAzureResourcesRequest
	16,  // 85: illumio.cloud.config.v1.ConfigService.ReadApplicationAzureResources:input_type -> illumio.cloud.config.v1.ReadApplicationAzureResourcesRequest
	18,  // 86: illumio.cloud.config.v1.ConfigService.UpdateApplicationAzureResources:input_type -> illumio.cloud.config.v1.UpdateApplicationAzureResourcesRequest
	20,  // 87: illumio.cloud.config.v1.ConfigService.DeleteApplicationAzureResources:input_type -> illumio.cloud.config.v1.DeleteApplicationAzureResourcesRequest
	24,  // 88: illumio.cloud.config.v1.ConfigService.CreateApplicationPolicyRule:input_type -> illumio.cloud.config.v1.CreateApplicationPolicyRuleRequest
	26,  // 89: illumio.cloud.config.v1.ConfigService.ReadApplicationPolicyRule:input_type -> illumio.cloud.config.v1.ReadApplicationPolicyRuleRequest
	28,  // 90: illumio.cloud.config.v1.ConfigService.UpdateApplicationPolicyRule:input_type -> illumio.cloud.config.v1.UpdateApplicationPolicyRuleRequest
	30,  // 91: illumio.cloud.config.v1.ConfigService.DeleteApplicationPolicyRule:input_type -> illumio.cloud.config.v1.DeleteApplicationPolicyRuleRequest
	31,  // 92: illumio.cloud.config.v1.ConfigService.CreateAwsAccount:input_type -> illumio.cloud.config.v1.CreateAwsAccountRequest
	33,  // 93: illumio.cloud.config.v1.ConfigService.ReadAwsAccount:input_type -> illumio.cloud.config.v1.ReadAwsAccountRequest
	35,  // 94: illumio.cloud.config.v1.ConfigService.UpdateAwsAccount:input_type -> illumio.cloud.config.v1.UpdateAwsAccountRequest
	37,  // 95: illumio.cloud.config.v1.ConfigService.DeleteAwsAccount:input_type -> illumio.cloud.config.v1.DeleteAwsAccountRequest
	38,  // 96: illumio.cloud.config.v1.ConfigService.CreateAwsFlowLogsS3Bucket:input_type -> illumio.cloud.config.v1.CreateAwsFlowLogsS3BucketRequest
	40,  // 97: illumio.cloud.config.v1.ConfigService.ReadAwsFlowLogsS3Bucket:input_type -> illumio.cloud.config.v1.ReadAwsFlowLogsS3BucketRequest
	42,  // 98: illumio.cloud.config.v1.ConfigService.UpdateAwsFlowLogsS3Bucket:input_type -> illumio.cloud.config.v1.UpdateAwsFlowLogsS3BucketRequest
	44,  // 99: illumio.cloud.config.v1.ConfigService.DeleteAwsFlowLogsS3Bucket:input_type -> illumio.cloud.config.v1.DeleteAwsFlowLogsS3BucketRequest
	45,  // 100: illumio.cloud.config.v1.ConfigService.CreateAzureFlowLogsStorageAccount:input_type -> illumio.cloud.config.v1.CreateAzureFlowLogsStorageAccountRequest
	47,  // 101: illumio.cloud.config.v1.ConfigService.ReadAzureFlowLogsStorageAccount:input_type -> illumio.cloud.config.v1.ReadAzureFlowLogsStorageAccountRequest
	49,  // 102: illumio.cloud.config.v1.ConfigService.UpdateAzureFlowLogsStorageAccount:input_type -> illumio.cloud.config.v1.UpdateAzureFlowLogsStorageAccountRequest
	51,  // 103: illumio.cloud.config.v1.ConfigService.DeleteAzureFlowLogsStorageAccount:input_type -> illumio.cloud.config.v1.DeleteAzureFlowLogsStorageAccountRequest
	52,  // 104: illumio.cloud.config.v1.ConfigService.CreateAzureSubscription:input_type -> illumio.cloud.config.v1.CreateAzureSubscriptionRequest
	54,  // 105: illumio.cloud.config.v1.ConfigService.ReadAzureSubscription:input_type -> illumio.cloud.config.v1.ReadAzureSubscriptionRequest
	56,  // 106: illumio.cloud.config.v1.ConfigService.UpdateAzureSubscription:input_type -> illumio.cloud.config.v1.UpdateAzureSubscriptionRequest
	58,  // 107: illumio.cloud.config.v1.ConfigService.DeleteAzureSubscription:input_type -> illumio.cloud.config.v1.DeleteAzureSubscriptionRequest
	61,  // 108: illumio.cloud.config.v1.ConfigService.CreateDeployment:input_type -> illumio.cloud.config.v1.CreateDeploymentRequest
	63,  // 109: illumio.cloud.config.v1.ConfigService.ReadDeployment:input_type -> illumio.cloud.config.v1.ReadDeploymentRequest
	65,  // 110: illumio.cloud.config.v1.ConfigService.UpdateDeployment:input_type -> illumio.cloud.config.v1.UpdateDeploymentRequest
	67,  // 111: illumio.cloud.config.v1.ConfigService.DeleteDeployment:input_type -> illumio.cloud.config.v1.DeleteDeploymentRequest
	70,  // 112: illumio.cloud.config.v1.ConfigService.CreateIpList:input_type -> illumio.cloud.config.v1.CreateIpListRequest
	72,  // 113: illumio.cloud.config.v1.ConfigService.ReadIpList:input_type -> illumio.cloud.config.v1.ReadIpListRequest
	74,  // 114: illumio.cloud.config.v1.ConfigService.UpdateIpList:input_type -> illumio.cloud.config.v1.UpdateIpListRequest
	76,  // 115: illumio.cloud.config.v1.ConfigService.DeleteIpList:input_type -> illumio.cloud.config.v1.DeleteIpListRequest
	77,  // 116: illumio.cloud.config.v1.ConfigService.CreateK8SCluster:input_type -> illumio.cloud.config.v1.CreateK8SClusterRequest
	79,  // 117: illumio.cloud.config.v1.ConfigService.ReadK8SCluster:input_type -> illumio.cloud.config.v1.ReadK8SClusterRequest
	81,  // 118: illumio.cloud.config.v1.ConfigService.UpdateK8SCluster:input_type -> illumio.cloud.config.v1.UpdateK8SClusterRequest
	83,  // 119: illumio.cloud.config.v1.ConfigService.DeleteK8SCluster:input_type -> illumio.cloud.config.v1.DeleteK8SClusterRequest
	84,  // 120: illumio.cloud.config.v1.ConfigService.CreateK8SClusterOnboardingCredential:input_type -> illumio.cloud.config.v1.CreateK8SClusterOnboardingCredentialRequest
	86,  // 121: illumio.cloud.config.v1.ConfigService.ReadK8SClusterOnboardingCredential:input_type -> illumio.cloud.config.v1.ReadK8SClusterOnboardingCredentialRequest
	88,  // 122: illumio.cloud.config.v1.ConfigService.UpdateK8SClusterOnboardingCredential:input_type -> illumio.cloud.config.v1.UpdateK8SClusterOnboardingCredentialRequest
	90,  // 123: illumio.cloud.config.v1.ConfigService.DeleteK8SClusterOnboardingCredential:input_type -> illumio.cloud.config.v1.DeleteK8SClusterOnboardingCredentialRequest
	92,  // 124: illumio.cloud.config.v1.ConfigService.CreateOrganizationPolicy:input_type -> illumio.cloud.config.v1.CreateOrganizationPolicyRequest
	94,  // 125: illumio.cloud.config.v1.ConfigService.ReadOrganizationPolicy:input_type -> illumio.cloud.config.v1.ReadOrganizationPolicyRequest
	96,  // 126: illumio.cloud.config.v1.ConfigService.UpdateOrganizationPolicy:input_type -> illumio.cloud.config.v1.UpdateOrganizationPolicyRequest
	98,  // 127: illumio.cloud.config.v1.ConfigService.DeleteOrganizationPolicy:input_type -> illumio.cloud.config.v1.DeleteOrganizationPolicyRequest
	102, // 128: illumio.cloud.config.v1.ConfigService.CreateOrganizationPolicyRule:input_type -> illumio.cloud.config.v1.CreateOrganizationPolicyRuleRequest
	104, // 129: illumio.cloud.config.v1.ConfigService.ReadOrganizationPolicyRule:input_type -> illumio.cloud.config.v1.ReadOrganizationPolicyRuleRequest
	106, // 130: illumio.cloud.config.v1.ConfigService.UpdateOrganizationPolicyRule:input_type -> illumio.cloud.config.v1.UpdateOrganizationPolicyRuleRequest
	108, // 131: illumio.cloud.config.v1.ConfigService.DeleteOrganizationPolicyRule:input_type -> illumio.cloud.config.v1.DeleteOrganizationPolicyRuleRequest
	110, // 132: illumio.cloud.config.v1.ConfigService.CreateTagToLabel:input_type -> illumio.cloud.config.v1.CreateTagToLabelRequest
	112, // 133: illumio.cloud.config.v1.ConfigService.ReadTagToLabel:input_type -> illumio.cloud.config.v1.ReadTagToLabelRequest
	114, // 134: illumio.cloud.config.v1.ConfigService.UpdateTagToLabel:input_type -> illumio.cloud.config.v1.UpdateTagToLabelRequest
	116, // 135: illumio.cloud.config.v1.ConfigService.DeleteTagToLabel:input_type -> illumio.cloud.config.v1.DeleteTagToLabelRequest
	1,   // 136: illumio.cloud.config.v1.ConfigService.CreateApplication:output_type -> illumio.cloud.config.v1.CreateApplicationResponse
	3,   // 137: illumio.cloud.config.v1.ConfigService.ReadApplication:output_type -> illumio.cloud.config.v1.ReadApplicationResponse
	5,   // 138: illumio.cloud.config.v1.ConfigService.UpdateApplication:output_type -> illumio.cloud.config.v1.UpdateApplicationResponse
	119, // 139: illumio.cloud.config.v1.ConfigService.DeleteApplication:output_type -> google.protobuf.Empty
	8,   // 140: illumio.cloud.config.v1.ConfigService.CreateApplicationAwsResources:output_type -> illumio.cloud.config.v1.CreateApplicationAwsResourcesResponse
	10,  // 141: illumio.cloud.config.v1.ConfigService.ReadApplicationAwsResources:output_type -> illumio.cloud.config.v1.ReadApplicationAwsResourcesResponse
	12,  // 142: illumio.cloud.config.v1.ConfigService.UpdateApplicationAwsResources:output_type -> illumio.cloud.config.v1.UpdateApplicationAwsResourcesResponse
	119, // 143: illumio.cloud.config.v1.ConfigService.DeleteApplicationAwsResources:output_type -> google.protobuf.Empty
	15,  // 144: illumio.cloud.config.v1.ConfigService.CreateApplicationAzureResources:output_type -> illumio.cloud.config.v1.CreateApplicationAzureResourcesResponse
	17,  // 145: illumio.cloud.config.v1.ConfigService.ReadApplicationAzureResources:output_type -> illumio.cloud.config.v1.ReadApplicationAzureResourcesResponse
	19,  // 146: illumio.cloud.config.v1.ConfigService.UpdateApplicationAzureResources:output_type -> illumio.cloud.config.v1.UpdateApplicationAzureResourcesResponse
	119, // 147: illumio.cloud.config.v1.ConfigService.DeleteApplicationAzureResources:output_type -> google.protobuf.Empty
	25,  // 148: illumio.cloud.config.v1.ConfigService.CreateApplicationPolicyRule:output_type -> illumio.cloud.config.v1.CreateApplicationPolicyRuleResponse
	27,  // 149: illumio.cloud.config.v1.ConfigService.ReadApplicationPolicyRule:output_type -> illumio.cloud.config.v1.ReadApplicationPolicyRuleResponse
	29,  // 150: illumio.cloud.config.v1.ConfigService.UpdateApplicationPolicyRule:output_type -> illumio.cloud.config.v1.UpdateApplicationPolicyRuleResponse
	119, // 151: illumio.cloud.config.v1.ConfigService.DeleteApplicationPolicyRule:output_type -> google.protobuf.Empty
	32,  // 152: illumio.cloud.config.v1.ConfigService.CreateAwsAccount:output_type -> illumio.cloud.config.v1.CreateAwsAccountResponse
	34,  // 153: illumio.cloud.config.v1.ConfigService.ReadAwsAccount:output_type -> illumio.cloud.config.v1.ReadAwsAccountResponse
	36,  // 154: illumio.cloud.config.v1.ConfigService.UpdateAwsAccount:output_type -> illumio.cloud.config.v1.UpdateAwsAccountResponse
	119, // 155: illumio.cloud.config.v1.ConfigService.DeleteAwsAccount:output_type -> google.protobuf.Empty
	39,  // 156: illumio.cloud.config.v1.ConfigService.CreateAwsFlowLogsS3Bucket:output_type -> illumio.cloud.config.v1.CreateAwsFlowLogsS3BucketResponse
	41,  // 157: illumio.cloud.config.v1.ConfigService.ReadAwsFlowLogsS3Bucket:output_type -> illumio.cloud.config.v1.ReadAwsFlowLogsS3BucketResponse
	43,  // 158: illumio.cloud.config.v1.ConfigService.UpdateAwsFlowLogsS3Bucket:output_type -> illumio.cloud.config.v1.UpdateAwsFlowLogsS3BucketResponse
	119, // 159: illumio.cloud.config.v1.ConfigService.DeleteAwsFlowLogsS3Bucket:output_type -> google.protobuf.Empty
	46,  // 160: illumio.cloud.config.v1.ConfigService.CreateAzureFlowLogsStorageAccount:output_type -> illumio.cloud.config.v1.CreateAzureFlowLogsStorageAccountResponse
	48,  // 161: illumio.cloud.config.v1.ConfigService.ReadAzureFlowLogsStorageAccount:output_type -> illumio.cloud.config.v1.ReadAzureFlowLogsStorageAccountResponse
	50,  // 162: illumio.cloud.config.v1.ConfigService.UpdateAzureFlowLogsStorageAccount:output_type -> illumio.cloud.config.v1.UpdateAzureFlowLogsStorageAccountResponse
	119, // 163: illumio.cloud.config.v1.ConfigService.DeleteAzureFlowLogsStorageAccount:output_type -> google.protobuf.Empty
	53,  // 164: illumio.cloud.config.v1.ConfigService.CreateAzureSubscription:output_type -> illumio.cloud.config.v1.CreateAzureSubscriptionResponse
	55,  // 165: illumio.cloud.config.v1.ConfigService.ReadAzureSubscription:output_type -> illumio.cloud.config.v1.ReadAzureSubscriptionResponse
	57,  // 166: illumio.cloud.config.v1.ConfigService.UpdateAzureSubscription:output_type -> illumio.cloud.config.v1.UpdateAzureSubscriptionResponse
	119, // 167: illumio.cloud.config.v1.ConfigService.DeleteAzureSubscription:output_type -> google.protobuf.Empty
	62,  // 168: illumio.cloud.config.v1.ConfigService.CreateDeployment:output_type -> illumio.cloud.config.v1.CreateDeploymentResponse
	64,  // 169: illumio.cloud.config.v1.ConfigService.ReadDeployment:output_type -> illumio.cloud.config.v1.ReadDeploymentResponse
	66,  // 170: illumio.cloud.config.v1.ConfigService.UpdateDeployment:output_type -> illumio.cloud.config.v1.UpdateDeploymentResponse
	119, // 171: illumio.cloud.config.v1.ConfigService.DeleteDeployment:output_type -> google.protobuf.Empty
	71,  // 172: illumio.cloud.config.v1.ConfigService.CreateIpList:output_type -> illumio.cloud.config.v1.CreateIpListResponse
	73,  // 173: illumio.cloud.config.v1.ConfigService.ReadIpList:output_type -> illumio.cloud.config.v1.ReadIpListResponse
	75,  // 174: illumio.cloud.config.v1.ConfigService.UpdateIpList:output_type -> illumio.cloud.config.v1.UpdateIpListResponse
	119, // 175: illumio.cloud.config.v1.ConfigService.DeleteIpList:output_type -> google.protobuf.Empty
	78,  // 176: illumio.cloud.config.v1.ConfigService.CreateK8SCluster:output_type -> illumio.cloud.config.v1.CreateK8SClusterResponse
	80,  // 177: illumio.cloud.config.v1.ConfigService.ReadK8SCluster:output_type -> illumio.cloud.config.v1.ReadK8SClusterResponse
	82,  // 178: illumio.cloud.config.v1.ConfigService.UpdateK8SCluster:output_type -> illumio.cloud.config.v1.UpdateK8SClusterResponse
	119, // 179: illumio.cloud.config.v1.ConfigService.DeleteK8SCluster:output_type -> google.protobuf.Empty
	85,  // 180: illumio.cloud.config.v1.ConfigService.CreateK8SClusterOnboardingCredential:output_type -> illumio.cloud.config.v1.CreateK8SClusterOnboardingCredentialResponse
	87,  // 181: illumio.cloud.config.v1.ConfigService.ReadK8SClusterOnboardingCredential:output_type -> illumio.cloud.config.v1.ReadK8SClusterOnboardingCredentialResponse
	89,  // 182: illumio.cloud.config.v1.ConfigService.UpdateK8SClusterOnboardingCredential:output_type -> illumio.cloud.config.v1.UpdateK8SClusterOnboardingCredentialResponse
	119, // 183: illumio.cloud.config.v1.ConfigService.DeleteK8SClusterOnboardingCredential:output_type -> google.protobuf.Empty
	93,  // 184: illumio.cloud.config.v1.ConfigService.CreateOrganizationPolicy:output_type -> illumio.cloud.config.v1.CreateOrganizationPolicyResponse
	95,  // 185: illumio.cloud.config.v1.ConfigService.ReadOrganizationPolicy:output_type -> illumio.cloud.config.v1.ReadOrganizationPolicyResponse
	97,  // 186: illumio.cloud.config.v1.ConfigService.UpdateOrganizationPolicy:output_type -> illumio.cloud.config.v1.UpdateOrganizationPolicyResponse
	119, // 187: illumio.cloud.config.v1.ConfigService.DeleteOrganizationPolicy:output_type -> google.protobuf.Empty
	103, // 188: illumio.cloud.config.v1.ConfigService.CreateOrganizationPolicyRule:output_type -> illumio.cloud.config.v1.CreateOrganizationPolicyRuleResponse
	105, // 189: illumio.cloud.config.v1.ConfigService.ReadOrganizationPolicyRule:output_type -> illumio.cloud.config.v1.ReadOrganizationPolicyRuleResponse
	107, // 190: illumio.cloud.config.v1.ConfigService.UpdateOrganizationPolicyRule:output_type -> illumio.cloud.config.v1.UpdateOrganizationPolicyRuleResponse
	119, // 191: illumio.cloud.config.v1.ConfigService.DeleteOrganizationPolicyRule:output_type -> google.protobuf.Empty
	111, // 192: illumio.cloud.config.v1.ConfigService.CreateTagToLabel:output_type -> illumio.cloud.config.v1.CreateTagToLabelResponse
	113, // 193: illumio.cloud.config.v1.ConfigService.ReadTagToLabel:output_type -> illumio.cloud.config.v1.ReadTagToLabelResponse
	115, // 194: illumio.cloud.config.v1.ConfigService.UpdateTagToLabel:output_type -> illumio.cloud.config.v1.UpdateTagToLabelResponse
	119, // 195: illumio.cloud.config.v1.ConfigService.DeleteTagToLabel:output_type -> google.protobuf.Empty
...
func file_illumio_cloud_config_v1_config_proto_init() {
	...
	file_illumio_cloud_config_v1_config_proto_msgTypes[93].OneofWrappers = []any{}
	...
	file_illumio_cloud_config_v1_config_proto_msgTypes[97].OneofWrappers = []any{}
	...
	file_illumio_cloud_config_v1_config_proto_msgTypes[107].OneofWrappers = []any{}
	type x struct{}
